...
Tailoring is a new Artisan skill. Tailoring is one of the first skills which allows crafting of worn equipment that can boost your stats. Tailoring crafted equipment mostly fills the Hands, Chest and Legs slots and comes in several tiers (the tiers are not necessarily strict upgrades, they have different stat priorities):

* Tatty: Global bonuses  
* Grassknot/Spikescale/Rootweave/Elderhide: All Gathering Skill bonuses  
* Apprentice/Journeyman/Spectral: All Artisan Skill bonuses  
* Shadowquill/Aerofibril: All Utility Skill bonuses

There are two new pets: a new Mummy pet which provides Tailoring bonuses and a Tiger pet which provides Hunting bonuses. Both new pets give a Global Find Collectibles boost. The shark tooth trinket can now be used to make a Hunting focused necklace with a Global \-2% steps bonus which could come into play with ultra high step count activities. There is a new Spider Trinket and associated necklace with a Global \+2 XP bonus. (The Amulet of Animal Kingdom was updated to require this new Trinket as well). Kelp Diving Gear was moved to be a Tailoring recipe.

There are several new upgradable items. 

* Camo Face Paint (Hunting Chests) \-\> Bright Camo Face Paint   
* Crafting Pants (Crafting Chests) \-\> Extra Crafty Pants  
* Durable Fabric Cutting Mat (Tailoring Chests) \-\> Golden Cutting Mat  
* Pretty Pliers (Trinketry Chests) \-\> Gem Tipped Pliers  
* Simple Sewing Needle (Various Tool Shops and Tailoring Chests) \-\> Silver/Gold Sewing Needle  
...
* Less time spent traveling and more time spent in a single zone (more AFK, less micromanaging phone)  
* Will have higher base skill level when arriving at new zones/activities  
* Faster access to the Achiever Capes (remember each collectible gives 1 Achievement point)  
* Gotta catch 'em all\!

Cons:

* Because we focus on drops instead of XP, it will be slower leveling  
* Rare drops and Collectibles come from activities, so you’ll be light on materials to craft high quality tools  
* Spends extra time on skills which you may not care about. If your aim is to be the best swordsmith, this guide will take lots of detours compared to only focusing on specific skills which work towards that goal
...
* Double Rewards/Action: A second bite at the apple  
  * The difference between these two is subtle but important. Double reward will give you a second roll on the loot table and nothing else. Double action also gives a second roll on the loot table, but also gives 2x XP and consumes 2x materials/food.   
  * Meaning Double Action is strictly better for actions that consume no resources like Traveling and Gathering. While Double Reward is generally better for resource limited activities like Crafting, Transforming or anything where you want to preserve food buffs.  
* Chest Finding: While not directly helpful for rare drops, this will get you activity chest equipment which will likely have some of the above stats  
...
* Many pieces of chest equipment can be upgraded, some are noted throughout the guide but check here for a full list before trading anything away: [https://wiki.walkscape.app/wiki/Upgraded\_Equipment](https://wiki.walkscape.app/wiki/Upgraded_Equipment)  
* Only one of the Extreme achievements has any special requirements, they just take tons of time walking. We’ll only be tracking the status of the one Extreme achievement.  
* Check the job boards every day to see if you can easily complete any jobs, advancing reputations and faction chests drops can have some great rewards.  
  * Jarvonia: Kallaheim, Azurazera  
  * Trellin: Granfiddich, Everhaven  
  * Erdwise: Blackspell Port, Everhaven  
  * Halflings: Halfling Campground  
  * Syrenthia: Vastalume  
* Remember when equipping gear to look for items with GLOBAL bonuses. For example, if you’re looking for Fine Materials on Mining equipment, you’ll miss out on things like the Rusty Spyglass and Trash Grabber. Use the in game gearset tool or the online tool [https://gear.walkscape.app](https://gear.walkscape.app) and filter by activity. This will show all gear which provides any bonus while performing that activity (even global bonuses).  
* You will need to periodically clear your bags while hunting rares. Feel free to drop or sell items you KNOW you won’t need later, but when in doubt return to a bank even if you spend some extra steps doing so.  
...
* Talk to Herbert, and select the “Foraging” option under Guidance for a free Good (Green) quality Basic Sickle.  
* “Buy” Herbert’s free sticks/stones/twine and craft a basic hatchet, pickaxe and net. If you stay in the starter area for multiple days, collect the free sticks/stones/twine daily.  
* Do **NOT** equip gear until your first 10,000 steps for an achievement. (***Tools are fine to equip)***  
* Any time your bags get full, hop over to Kallaheim to bank your inventory.  
* Equip the basic net/hatchet/pickaxe **\[Easy Achievement 1\]**  
  * With the 50 coins you got you can buy Herbert’s Cape, Boots and Hat (remember not to equip them until you get the 10,000 unequipped step achievement\!)  
  * Herbert's Gear will fill in any time you don't have an activity specific item for that slot  
* Equip the basic sickle and get Foraging to 10 **\[Easy Achievement 2\]**  
  * Also drop a Thistle **\[Easy Achievement 3\]**  
  * Make sure you have at least 3 Moondaisies, 3 Snowdrops and 1 Hemp  
* Cut Birch trees to Woodcutting level 10 and Pine Trees to 15  
* Go South to the Pit of Pittance, Mine Copper to Mining 10 and Mine Tin to Mining 15  
* Go West to Beach of Woe, fish till you have 45 raw shrimp  
* Build Sandcastles for \#\#Lost Timmy’s Sand Shovel **\[Collectible 1\]** (complete at least 15 times even if you get lucky and find the shovel quickly)  
  * If you ever need to check how many times you’ve completed an activity, you can open the menu next to your inventory to access the WalkPedia and check the stats of any activity you’ve performed.  
...
* You’re going to need a bare minimum of 145 coins to buy equipment in the next couple of towns. If you’re short you can sell cooked shrimp, or do Flame Stoking to get your starter coins.  
* Bank everything except for whatever Agility and Foraging gear you may have (make sure to include the Keen Eye Lenses), a Sickle, a Hunting Bow, a Flower Necklace, Herbert's gear, and three junk items to sell. Take your birch skis too (you should have gotten them from Herbert’s reputation). If you have over 750 coins, buy a simple ring and equip it along with your shiny ring **\[Easy Achievement 6\]**. Otherwise save your coins for tools in the next section.  
* Your Agility should be at least level 5 from traveling and forest foraging and you should be done with the gearless 10,000 step achievement **\[Easy Achievement 7\]**.  
  * You may have also found a chest, memosphere, and/or fine material item which will tick off additional achievements. If not, no worries these will happen relatively quickly. **\[Easy Achievements 8, 9, 10\]**
...
* Do Plains Foraging to level 25 Foraging, 400 total Flax+Hemp and **\!\!Sticky Finger Shorts**. While doing so, make sure you become overencumbered once **\[Easy Achievement 11\]**  
* Travel North to Nurturing Nook Springs  
* Do Sledding at least 25 times for part of a normal achievement  
  * (OPTIONAL) Do Sledding 100 times instead if you want a Jarvonia Faction rep  
* Travel West to Barbantok **\[Easy Achievement 12\]**  
* Do Jarvonia Skydisc Course 10 times to unlock the ability to equip the Golden Skydisc  
  * We'll come back for the Wood Carving/Tinkering drops later\!  
* Travel Northwest to Nomad Woods and sell the last junk to Woodcutter’s Cabin (5/20)  
* By this point you should have done over 55,000 steps **\[Easy Achievement 13\]**  
* Return to Kallaheim and buy the **\!\!Lumberjack Boots**
...
* Make sure to claim the Ring of Homesickness for a quick way back to Kallaheim from now on\! Equip the ring temporarily for part of an achievement, but the ring does NOT need to be equipped to use.
...
* Return to Kallaheim and get out your best **Agility** gear and a climbing tool  
* Travel Northwest from Norsack Plains to Frostbite Mountains  
* Do Mountain Climbing for the $$Iron Thermos  
* If you don’t have 150 Copper Ore, 150 Tin Ore and 100 Iron Ore (including what’s in your bank), get your **Mining** gear from Kallaheim, return to Frostbite Mountains and Mine Copper, Tin and Iron until you have that much  
* Travel back to Kallaheim and Smith all of your Copper and Tin Ore into Bronze Bars, Silver Nuggets to Silver Bars, and Gold Nuggets into Gold Bars. Smith a Bronze Shield and enough Bronze Swords to hit level 20\. Then smith all of your Iron Ore into Iron Bars.  
  * Equip the sword/shield for the achievement to have all gear slots full **\[Normal Achievement 3\]**. If you don’t have an item for all gear slots you should soon.  
...
* Go to Frostbite Mountain and do Cliff Foraging for **\!\!Feather Cape** and level 45 Foraging  
* We now need to hit level 45 Mining and Woodcutting. I recommend completing non-fine material gathering jobs from both Kallaheim and Azurazera job boards to get your Jarvonia rep up while leveling. Prioritize jobs that give faction/activity chests\! If you have no jobs to do, you can bank your steps, Mine Coal in Frostbite Mountains to 45 Mining, or Cut Oak Trees in the Nomad Woods to 45 Woodcutting.  
...
* Our tools are lagging behind quite a bit, so we’ll make a detour into Syrenthia for Hydrillium tools before going to GDTE. These tools grant additional chest finding by sacrificing the Fine Item stat  
* While in Syrenthia we can complete a fair number of achievements there, but we will need to return later for those that need a few more levels
...
* Go South to Elara’s Lagoon  
* Do Underwater Swimming 50 times for part of an achievement and to unlock the use of Hydrilium Diving Gear  
  * There are also $$Flippers, but I recommend getting these after Hydrilium Diving Gear  
* Return to Vastalume and bank everything
...
* You need up to 10,728 coins to afford Oak Skis (89), Sharp Machete (1,140), Backpack (4,999), and the Jarvonian Letter of Passage (4,500). Go to Port Skildar with your best **Chest Finding Carpentry** gear, do Brig Repair till you can buy the items you don’t have.  
  ...
  * Ice Sculpting in Frusenholm (**Chest Finding Crafting** gear) is another option. Not as many coins or as much XP as the other options, but Crafting chests have very desirable gear  
...
* Return to Salsfirth, equip your best **Efficiency** **Agility** gear.  
...
* Go to the Halfmaw Hideout and equip your best **Quality Outcome Carpentry** gear, also bring your **No Materials/Double Rewards Carpentry** gear, 3 light sources, 250 Bamboo Logs and a stack of Simple Bowstrings  
* Go Southeast to the Halfling Campgrounds and make a Great (Blue) quality Bamboo Hunting Bow. Then turn your Bamboo Logs into Planks to make a Great (Blue) quality Bamboo Toolbox.  
  * Depending on how much you want to swap gear, try to preserve some of your Bamboo logs to make Linen Cloth.  
* Equip your best **No Materials/Double Rewards Tailoring** gear  
* Create 480 Linen Cloth and 240 Basic Leather. Your gear and skill level should be at a point to complete the Tailor Swiftly Achievement **\[Easy Achievement 16\]**  
* Equip your best **Quality Outcome Tailoring** gear and make the Journeyman set of equipment, trying for a Great (Blue) quality of each. Equip the new pieces as you go once they outclass the Apprentice gear you’re wearing  
* Create a set of Spikescale equipment, trying for a Great (Blue) quality of each.  
* Equip your best **Efficiency Hunting** gear (no Arrows) and 3 light sources.  
* Go to Halfling Campgrounds and do Bird Watching for 60 Dark Feathers.  
* Go to Halfmaw Hideout and take out 1 copper/bronze arrow. Do Halfmaw Tracking once and sell the drop to the Adventurer’s Guild Outpost **\[Easy Achievement 17\]**  
* Return to Halfmaw Hideout and get your best **Efficiency Foraging** gear, and two light sources.  
...
* Go to Bilgemont Port, bank everything and equip your best **Efficiency Foraging** gear
...
* Return to Salsfirth, and with your best **No Material/XP Trinketry** gear, work towards level 40 Trinketry by shaping your Rough Gems  
  ...
  * You won't have enough gems to hit level 40\. Once you are out of Rough Opals, Star Pearls, and Wrentmarines, do the following in your best **Quality Outcome Trinketry** gear which should get you to 40:  
    * Create any amulet that you can once you reach the right level. Amulets give amazing XP for a minimal amount of material.  
    * Create Silver Opal/Star Pearl Rings and/or Silver (or Gold) Wrentmarine Rings  
* Equip your best **Find Collectibles Trinketry** gear and go to Blackspell Port  
* Do Antique Market Assessor until level 55\. You may find the Meteorite Fragment, but we’ll be back later if you don’t get it by level 55\.  
  * Antique Market Assessor is fairly terrible XP/step, if you have the silver/gold bars to spare, stop at level 51, make the jewelry listed in the next step and then make Silver Opal/Star Pearl/Wrentmarine Rings for XP  
* Go back to Bilgemont Port and with your best **Quality Outcome Trinketry** gear create the following  
  * 2x Gold Topaz Rings (equip them)  
  * 1x Amulet of Pink Pearl (if you found a Pink Pearl Trinket from a Crafting chest)  
  * 1x Amulet of Finding/Eel/Heron/Cooling Ice/Shark Tooth/Spider/Beaver if you didn’t while getting to level 40  
  * 2x Gold Ruby Rings  
  * 2x Gold Jade Rings  
...
* Before you leave Wraithwater aim for the following:  
  ...
  * 1 Spectral Pan (Good quality is good enough)  
  ...
  * At least 20 total spectral items crafted **\[Normal Achievement 17\]**  
* Equip your best **Efficiency Hunting** gear and your 300 Box Traps  
...
* We finally got to Trinketry and were able to get some starter rings and amulets to help us through the next sections  
* Our skills are progressing nicely, we’ve hit the skill requirements for most activities in the game.
...
* Return to Kallaheim and equip your best **Double Reward/Action/Fine Material Agility** gear (and Skis, Climbing Gear, and Wanderlust Walking Stick if you have one) for the Rescue Team grind  
  * You only need 25% efficiency from gear to hit the cap so fill up with as much Double Action/Reward, Fine Material as you can otherwise  
  * Pins are worth 2, Tags: 10, Remains: 20 (and Fine variants are 5x the normal amount)  
  * Double Action/Reward is **much** better than Fine Material. Let’s say normally doing 100 completions gives 99 regular drops and 1 fine drop. Increasing your Double Reward by 10% means 109 regular drops and 1 fine drop (114 tokens). Increasing your Fine Material by 100% means 98 regular drops and 2 fine drops (108 tokens).   
  * Here is an example loadout:  
    * Cape: Feather Cape  
    * Back: Grappling Hook (or Lily Pad if you have it and need Agility Chest gear)  
    * Head: Running Visor  
    * Hands: Aerofibril Bracers  
    * Neck: Amulet of Cooling Ice (Perfect Quality or better Amulet of Eel instead if you have one)  
    * Chest: Aerofibril Plastron  
    * Legs: Flowy Trousers  
...
* Complete Cleaning the Holy Fountain once with your diving gear equipped **\[Normal Achievement 24\]**, then with your normal gear on continue the activity until you find the \#\#Flame of Azura and \#\#Cold Embrace **\[Collectibles 17,18\]**  
  * Continue to to jobs while cleaning the fountain to hit 125 reputation which gives another collectible \#\#Sigil of the Ordained **\[Collectible 19\]** at 125 rep.  
  * I recommend getting all the way to 150 reputation as the new bank location at Azurazera is extremely helpful in the next section
...
* With your **No Materials/Double Reward Cooking** gear create all the Sweet Carrot Pies you can  
* Cook 20 different recipes **\[Normal Achievement 29\]**  
  * You should have the materials to cook (or have cooked) the following 23 items:  
  * Perch, Shrimp, Nettle Tea, Carp, Bread, Pike, Porridge, Pancakes, Trout, Chocolate Milk, Bagel, Milk, Salmon, Jellyfish, Trout Soup, Mushroom Curry, Lobster, Mud Pie, Jelly Sandwich, Swordfish, Sweet Carrot Pie, Salmon Pie, Fried Fish Sandwich  
* With your best **Quality Outcome Crafting** gear and whatever Farganite Bars/Mangrove Planks you’ve gotten from skill chests, try to make a Great (Blue) Quality Farganite Pickaxe  
* Do Underwater Swimming with **Underwater Efficiency Agility** gear for $$Flippers if you want  
* Equip your best **Underwater Efficiency Spear Fishing** gear and go to Casbrant’s Grave  
  * Casbrant’s Grave is tagged as Spectral, make sure you’re using your Spectral Tools/Gear, Ghost Trap Pack, and Wraithwater Flower Necklace  
* Do Sea Fishing (Spear) for the **\!\!Eye Patch**  
* Return to Vastalume and equip your best **Underwater Find Collectibles Spear Fishing** gear  
* Travel Northwest to Darktide Trench and do Predator Fishing (Spear) for the \#\#Anglerfish Mask **\[Collectible 25\]**, a **\!\!Shark**, and level 60 Fishing  
* Return to Vastalume and equip your best **Underwater Efficiency/Fine Item Foraging** gear  
* Go to Casbrant’s Grave and do Wreck Diving for **\!\!6,000 Sea Shells**, a **\!\!Pirate Hat**, and the \#\#Dinglehopper **\[Collectible 26\]**  
  * Again, make sure you’re using your Spectral items\!  
* Buy **\!\!Swashbuckler Sword** in Casbarant’s Grave and **\!\!Underwater Map** **\[Collectible 27\]** in Vastalume  
* Get your best **Underwater Efficiency Mining** gear and two light sources, go to Underwater Cave   
* Do Cave Diving for a **\!\!Glowstick** then do Explore Underwater Cave  
* Now that you’re in Bog Bottom, do Underwater Aqueduct Digging 100 times to unlock the Underwater Aqueduct Construction action and until you have found 1000 gold nuggets **\[Normal Achievement 30\]**  
* Explore all the undiscovered zones in the Bog **\[Normal Achievement 31\]**  
  * You could farm 1-2 $$Ring of Pandemonium (Underwater Aqueduct Digging using **Underwater Efficiency Mining** gear in Bog Bottom). The rings are great, but finding *one* will take hundreds of thousands of steps. Use dynamite consumables if you go for it.
...
* Go to Bilgemont Port, equip your best **Transform Smithing** gear, and smith all your Silver and Gold Nuggets into Bars. Make sure you have at least 2 bars of each other Shield metal type that you haven’t yet created aside from Farganite (Iron/Steel/Tarsillium). We’ll have to do Farganite at an Advanced Forge later with the Gem Shield.  
  * Smith the rest of your ore into bars until you hit at least level 59 Smithing  
  * If you do NOT hit 59 Smithing, you can smith the silver nuggets which dropped as a byproduct of smithing bars or go to Port Skildar and do Horseshoe Making until 59  
* Go to Bilgemont Port and equip your best **Chest Finding/XP Agility Gear** along with a weapon, shield, and light source  
* Do Guard Duty in Bilgemont Port until you have 100,000 coins and 80 Agility **\[Hard Achievements 8, 9\]**. Get to 102,777 coins and buy the $$Map of Arenum for 25,000 if you want so you still have access to the Erdwise Trinketry Factory which requires holding 77,777 coins.  
  * Keep farming Gem Pouches until you can complete the Infinity Stones Achievement  
  * Hold on to at least one of each gem for Smithing a Gem Shield later\!  
* Equip your best **Find Collectibles Trinketry** gear and go to Blackspell Port  
* Do Antique Market Assessor until level 64 and until you get the \#\#Meteorite Fragment **\[Collectible 28\]**  
  * Once you get the Meteorite Fragment you can swap your gear to **Double Reward/Action/Fine Material**  
  * If you haven’t found a “Fine” Rough Star Pearl yet get it here **\[Hard Achievement 10\]**.  
* Go to Bilgemont Port to quip your best **No Material/Double Reward Trinketry** gear, take all your rough gems and go to Blackspell Port to shape them. Make sure you have one of each cut gem in your inventory simultaneously **\[Hard Achievement 11\]**  
* Go to Bilgemont Port, equip your best **Quality Outcome Trinketry** gear (don’t forget your Sweet Carrot Pies\!) and create Rings and Amulets in Blackspell Port  
  * Create Gold Topaz Rings and equip them (try for 2x Great Quality)  
  ...
  * Create the following Rings (try for 2 Great quality of each)  
    * Silver and Gold Ruby Rings   
      * Both variations are useful (Silver for farming crafting materials, Gold for Transformations and Collectible hunting), but your Ruby supply will be severely limited, it will be hard to get Great quality for both Silver and Gold.  
    * Gold Jade Rings  
    * Silver Opal/Star Pearl/Wrentmarine Rings (mostly for XP, the stats on these aren’t great)  
    * I recommend waiting to craft Gold Ethernite and Gold Sun Stone Rings until you get better Quality Outcome gear  
* If you didn’t hit level 67 Trinketry, do more Antique Market Assessor **\[Hard Achievement 12\]**  
* By now you should have completed the achievement to walk 3.8 million steps **\[Hard Achievement 13\]**  
* (OPTIONAL) We’re going to want as much Quality Outcome as possible in the next section, here are some options to boost this up:  
  * Do Ice Sculpting with your best **Chest Drop Carpentry** gear. Any of the Rare, Epic or Legendary equipment drops from Crafting Chests will make the next section much easier. Remember you can use the Mysterious Merchant to trade in duplicate items for gear you may be missing\!  
  * Return to Blackspell Port with your best **Quality Outcome Trinketry** gear and create Gold Ethernite Rings and/or Pink Pearl Amulets
...
* We’ve unlocked every point-locked achievement reward (aside from the Cape of Achiever), and we can now do most activities in the game. I won’t be tracking skill levels anymore.
...
* Return to Wraithwater and equip your best **Find Collectibles Foraging** gear  
* Go back to Tendon Wet Fields and do Flooded Field Scavenging for a **\!\!Jar of Dirt \[Collectible 29\]** and a $$Tiger Egg  
* Return to Wraithwater to start the 5k ectoplasm grind. Wraithwater is a Spectral location, your Wraithwater Flower Necklace and Ghost Trap Pack should be equipped at all times in this zone.  
...
* Return to Blackrane and equip your best **Find Collectibles Agility** gear  
* Go back to Kildome Cross and do Shoreline Scramble for $$Feather Boots and \#\#Shiny Broken Skydisk **\[Collectible 32\]**  
...
* By this point you should have a bunch of light sources. If you’ve followed this guide you will have a Simple Torch, Hand Lantern, Fireflies in Jar, Glowstick, and a Gem Shield. Equip 5 light sources at the same time **\[Normal Achievement 34\]**.  
* Go to Salsfirth and equip your best **Quality Outcome Crafting** gear  
* Using fine materials ONLY, craft Basic Hatchets until you get an Eternal (Red) Quality **\[Hard Achievement 17\]**  
  * Using fine materials over normal materials increases the expected Eternal rate from one in thousands to one in dozens. If you run out of fine materials it is ALWAYS better to farm more.  
  * Don’t forget your sweet carrot pies\!  
* If you run out of fine sticks or stones you have two choices  
  * Equip your best **No Materials/Double Rewards Smithing** and **Carpentry** gear to turn your Fine Copper Ore/Birch Logs into Fine Ores/Planks to make Copper Hatchets  
  * Gather more fine sticks and stones using your best **Fine Item Woodcutting/Mining** gear by doing Branch Trimming in Coldington and Stone Quarrying in Sanguine Hills  
* Return to Kallaheim and get your best **Efficiency/Double Reward/Action Foraging** gear and prepare for *the original* long grind  
  * Max Efficiency is 180%, feel free to focus on Find Collectibles, Chest Finding, or XP if you surpass this cap and have no double reward/action left to equip  
* Go to the Winter Waves Glacier and do Glacier Foraging for the $$Blue Ice Sickle and \#\#Expedition Journal **\[Collectible 34\]**  
  * If you get lucky and get both drops quickly, you still need to complete the action 2,500 times **\[Hard Achievement 18\]**  
* Return to Kallaheim and equip your best **Fine Material Mining** gear  
* Go to the Pit of Pittance and do Surface Salt Mining for 50 “**Fine**” Salt Crystals  
* Go to Vastalume, and with your best **No Materials/Double Reward Cooking** gear cook as much Mushroom Curry as you can  
* Equip your best **Fine Item Foraging** gear. Bring consumables that improve your fine item drops. Veggie Soup \> Mushroom Curry \> Porridge.  
* Go to Elara’s Lagoon and do Merfolk Farm Foraging until you have at least 50 “**Fine**” Salty Hops.  
...
* \#\#Floating Coral (W.E.A.R.: \~70,000)  
* \#\#Easter Egg (W.E.A.R.: \~350,000)  
...
* Jarvonia (can be farmed by Sledding or Cleaning the Holy Water Fountain, 100 completions per point)  
  ...
  * Access to the Bigloo shop in Winter Waves Glacier at 60 points  
    * $$Baby Penguin Ice Lure, $$Ice Netrod sold for 4k coins each  
  * $$Zippy Kicksled at 80 points  
  * \#\#Sigil of the Ordained at 125 points  
  * Access to a new bank in Azurazera at 150 points  
  * Various mining consumables and unique mining equipment from the chests  
* Trellin (no way to farm aside from completing jobs)  
  * **\!\!Trusty Tent**, $$Mosquito Net Hat at 10, 30 points  
  * Various woodcutting consumables and unique woodcutting equipment from the chests  
* Erdwise (can be farmed by Antique Market Assessor, 100 completions per point)  
  * $$Proper Cape/Boots/Hat/Pants/Shirt at 5/10/20/30/45 points  
    * These give Quality Outcome bonuses to Trinketry and should be farmed before any expensive Jewelry is created  
  * Various trinketry consumables and unique trinketry equipment from the chests  
* Halfling (can be farmed by Underwater Aqueduct Construction, 100 completions per point)  
...
* Kelp/Volcanic Rock for Diving Equipment  
  * Crafting and Selling Hydrilium Diving Equipment is a decent money maker with high enough Quality Outcome  
* Iron/Coal/Jade for Jade Tipped Steel Pan which gives an excellent Find Collectibles boost to ALL Artisan skills  
* Various materials to upgrade certain chest drops (Miner’s Magnet to Hydrilium Magnet, Walking Stick to Wanderlust Walking Stick, etc)   
* Most Rings have some utility. I feel that the Gold variants are almost always better than the Silver variant because the Fine Material bonus is almost never worth it over the increased gemstone bonuses granted by Gold  
  * For endgame activities I think these would be best:  
    * Farming Materials \- Silver or Gold Ruby Ring (If you still want to hunt for activity chest drops Gold is better. The higher the quality, the better Silver becomes for Fine Items over the Gold variant)  
    * Transforming \- Gold Topaz or Ruby Ring  
    * Crafting \- Gold Ethernite Ring  
    * Collectible Hunting \- Gold Jade Ring  
    * Money or Chest Farming \- Gold Sunstone Ring  
    * XP Farming \- Old Gold Rings (drop from Activities)  
* For Amulets the main question is if the Amulet of the Animal Kingdom is better than the activity specific Amulet. The Animal Kingdom amulet has an odd collection of stats. It’s probably best in slot for XP grinding any skill with high values in XP, Chest Finding, and Lowered Step Count. But if you’re farming materials or crafting gear the activity specific amulet is usually better.
